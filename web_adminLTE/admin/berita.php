                    ...
                    <div class="col-6">
                        <form>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="isi_data" class="form-control" rows="10"></textarea>
                                </div>
                            </div>
        ...
        <div class="container">
            ...
            <form action="proses_berita.php?proses=update" method="POST" enctype="multipart/form-data">
                <div class="row mb-3">
                    <label for="nama_berita" class="col-sm-2 col-form-label">Judul</label>
                    <div class="col-sm-10">
                        <input type="text" name="judul" class="form-control" value="<?= $data_berita['judul'] ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="nama_berita" class="col-sm-2 col-form-label">Kategori</label>
                    <div class="col-sm-10">
                        <select name="kategori_id" class="form-select">
                            ...
                            while ($data_kategori = mysqli_fetch_array($kategori)) {
                                $selected = $data_kategori['$id'] == $data_berita['$prodi_id'] ? 'selected' : '';
                ...
                <div class="row mb-3">
                    <label for="keterangan" class="col-sm-2 col-form-label">Isi Berita</label>
                    <div class="col-sm-10">
                        <textarea name="isi_data" class="form-control" rows="10"><?= $data_berita['isi_data'] ?></textarea>
                    </div>
                </div>
